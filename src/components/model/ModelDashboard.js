...
const blocks = [
  {
    title: "Model1",
    description: "Description of model 1 involves analysing quality data Description of dataset 1 involves analysing quality data",
  },
  {
    title: "Model 2",
  ...
  return (
    <div className="model-dashboard-main">
        ...
        <div className="py-2 px-sm-4 px-3 model-dash-content">
          ...
          <div>
            <div className='py-sm-3 py-2 model-search-div'>  
              <input type='text' placeholder='Search here' className='model-search-bar' value={searchQuery}
      ...
      <div>
        ...
        <div className="dropdown py-3 px-md-5 px-sm-4 px-3 d-flex d-lg-none justify-content-end model-dash-btns">
          <button type="button" class="model-dropdown-btn dropdown-toggle" data-bs-toggle="dropdown">
            Filter category
          </button>
          <ul class="dropdown-menu">
            <li><a class={`dropdown-item ${
                activeComponent === "allModels" ? "active-button" : ""
              }`} href="#">All Models</a></li>
        ...
        <div ref={modelDivRef}>
          <div className="row px-0 all-model-main mt-4 py-3 px-sm-3 container-fluid justify-content-around">
            {filteredModels.map((item, key) => (
              <div className="col-xxl-3 col-md-5 col-sm-7 col-11 mx-1 mb-5 all-model-component" index={key}>
                ...
                <div className="all-model-details">
                  ...
                  <div className="all-model-btn" onClick={() => navigate('/model/single-model')}>View More &gt;</div>
                </div>
              </div>
            ))}
          </div>
