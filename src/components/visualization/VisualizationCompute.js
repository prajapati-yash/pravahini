          ...
          <div className='visualization-compute-data'>
            <div className='py-2'>
              ...
              <div className='d-flex align-items-center'>
                <div className='py-2'>
                  <input type='text' className='visualization-compute-dataset-input' placeholder='Enter Dataset URL'/>
                </div>
                <div className='d-flex'>
                  <img className='visualization-compute-dataset-img' src={add} />
                </div>
              </div>
            </div>
            ...
            <div className='py-2'>
              ...
              <div className='d-lg-flex align-items-center'>
                <div className='py-2'>
                  <input type='text' className='visualization-compute-model-input' placeholder='Enter Model URL'/>
                </div>
                <div>
                  <button className='rounded-pill visualization-compute-model-btn'>Compute</button>
                </div>
              </div>
            </div>
            ...
            <div className='d-flex py-2 align-items-center'>
              ...
              <div className='px-3'>
                <button className='rounded-pill visualization-compute-cid-btn'>Get cid</button>
              </div>
            </div>
